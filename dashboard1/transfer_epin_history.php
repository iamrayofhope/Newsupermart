<?php
		...
		$co = $obj->COUNT_TOTAL_EPINS2($pid);
		$res = $obj->GET_TRANSFER_RECORD($pid);
...
<div class="inner-block">
    <div class="blank">
    	<h2>Tranfer E-pins History</h2><span>( <b><?php echo $co." Records Found !"?></b> )</span>
    ...
    <tbody>
      ...
      <tr>
		...
		if($arr['status']=="1")
			...
			echo '<span class="label label-primary">Used</span>'
		?>
        </td>
      </tr>
    		<?php
