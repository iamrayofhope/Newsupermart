<?php
		...
		$self_team = $obj->COUNT_SELF_TEAM($pid);
...
<div class="inner-block">
				...
				?>
 				<div class="alert alert-danger">
                      <strong>Status is not Activated</strong>
                    </div>
				<?php
					}
				?>
...
<div class="chit-chat-layer1">
	<div class="col-md-9 chit-chat-layer1-left">
               <div class="work-progres">
                            ...
                            <tr>
                            	<td colspan="6"><a href="self_team.php" class="btn btn-primary btn-group-lg">See More</a></td>
                            </tr>  
